...
import com.project.mall.portal.domain.ConfirmOrderResult;
import com.project.mall.portal.domain.OmsOrderDetail;
import com.project.mall.portal.domain.OrderParam;
import com.project.mall.portal.service.OmsPortalOrderService;
...
public class OmsPortalOrderController {
    ...
    public CommonResult<CommonPage<OmsOrderDetail>> list(
            @Parameter(description = "订单状态：-1->全部；0->待付款；1->待发货；2->已发货；3->已完成；4->已关闭", schema = @Schema(allowableValues = {"-1", "0", "1", "2", "3", "4"}))
