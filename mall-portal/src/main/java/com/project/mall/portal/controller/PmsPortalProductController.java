...
import com.project.mall.portal.domain.PmsPortalProductDetail;
import com.project.mall.portal.domain.PmsProductCategoryNode;
import com.project.mall.portal.service.PmsPortalProductService;
...
public class PmsPortalProductController {
    ...
    public CommonResult<CommonPage<PmsProduct>> search(@RequestParam(required = false) String keyword,
                                                       ...
                                                       @Parameter(description = "排序字段:0->按相关度；1->按新品；2->按销量；3->价格从低到高；4->价格从高到低", schema = @Schema(allowableValues = {"0", "1", "2", "3", "4"}))
